...
img_path = "/home/dyjung/amr_ws/ml/project/data/nick.png"
...
def img_augmentation():
    ...
    #저장할 경로 가져오기, 만들기 
    directory_path = os.path.dirname(img_path) +"/" + dist_folder_name
    ...
    for val in rot_angle:
        ...
        for rn in random_numbers:
            ...
            save_path = directory_path + "/augImg" + str(img_index) +".jpg"
