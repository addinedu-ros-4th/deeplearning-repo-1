...
# 저장된 모델 불러오기
model = load_model("/home/bo/amr_ws/dl_project/model/model_mlp_grab.h5") # mlp
# model = load_model("/home/bo/amr_ws/dl_project/model/model_cnn_grab.h5")   # cnn : 이미지 처리에 효과적임



# 마디아 파이프 라이브러리의 Holistic 모델을 로드합니다.
mp_drawing = mp.solutions.drawing_utils             # Mediapipe의 디폴트 스타일을 가져옵니다.
mp_hands = mp.solutions.hands                       # Hand 모델을 초기화합니다.
        ...
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if hand_landmarks:
                ...
                for landmark in hand_landmarks.landmark:
                    landmark_image.append([landmark.x, landmark.y])
